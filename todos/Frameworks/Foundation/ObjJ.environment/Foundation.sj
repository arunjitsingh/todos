...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("filteredSetUsingPredicate:"),function(_33,_34,_35){
with(_33){
var _36=objj_msgSend(_33,"count"),_37=objj_msgSend(CPSet,"set"),i;
for(i=0;i<_36;i++){
var _38=objj_msgSend(_33,"objectAtIndex:",i);
if(objj_msgSend(_35,"evaluateWithObject:",_38)){
objj_msgSend(_37,"addObject:",_38);
}
}
return _37;
}
}),new objj_method(sel_getUid("filterUsingPredicate:"),function(_39,_3a,_3b){
with(_39){
var _3c=objj_msgSend(_39,"count");
while(--_3c>=0){
var _3d=objj_msgSend(_39,"objectAtIndex:",_3c);
if(!objj_msgSend(_3b,"evaluateWithObject:",_3d)){
objj_msgSend(_39,"removeObjectAtIndex:",_3c);
}
}
}
})]);
...
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("initWithString:args:"),function(_3e,_3f,_40,_41){
with(_3e){
_3e=objj_msgSendSuper({receiver:_3e,super_class:objj_getClass("CPPredicateScanner").super_class},"initWithString:",_40);
if(_3e!=nil){
_args=objj_msgSend(_41,"objectEnumerator");
}
return _3e;
}
}),new objj_method(sel_getUid("nextArg"),function(_42,_43){
with(_42){
return objj_msgSend(_args,"nextObject");
}
}),new objj_method(sel_getUid("scanPredicateKeyword:"),function(_44,_45,key){
with(_44){
var loc=objj_msgSend(_44,"scanLocation");
var c;
objj_msgSend(_44,"setCaseSensitive:",NO);
if(!objj_msgSend(_44,"scanString:intoString:",key,NULL)){
return NO;
}
if(objj_msgSend(_44,"isAtEnd")){
return YES;
}
c=objj_msgSend(objj_msgSend(_44,"string"),"characterAtIndex:",objj_msgSend(_44,"scanLocation"));
if(!objj_msgSend(objj_msgSend(CPCharacterSet,"alphanumericCharacterSet"),"characterIsMember:",c)){
return YES;
}
objj_msgSend(_44,"setScanLocation:",loc);
return NO;
}
}),new objj_method(sel_getUid("parse"),function(_46,_47){
with(_46){
var r=nil;
try{
objj_msgSend(_46,"setCharactersToBeSkipped:",objj_msgSend(CPCharacterSet,"whitespaceCharacterSet"));
r=objj_msgSend(_46,"parsePredicate");
}
catch(error){
CPLogConsole("Parsing failed for "+objj_msgSend(_46,"string")+" with "+error);
}
finally{
if(!objj_msgSend(_46,"isAtEnd")){
CPLogConsole("Format string contains extra characters: \""+objj_msgSend(_46,"string")+"\"");
}
}
return r;
}
...
}),new objj_method(sel_getUid("parseOr"),function(_4e,_4f){
with(_4e){
var l=objj_msgSend(_4e,"parseNot");
while(objj_msgSend(_4e,"scanPredicateKeyword:","OR")||objj_msgSend(_4e,"scanPredicateKeyword:","||")){
var r=objj_msgSend(_4e,"parseNot");
...
}),new objj_method(sel_getUid("parseComparison"),function(_50,_51){
with(_50){
var _52=CPDirectPredicateModifier,_53=0,_54=0,_55,_56,p,_57=NO,_58=NO;
if(objj_msgSend(_50,"scanPredicateKeyword:","ANY")){
_52=CPAnyPredicateModifier;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","ALL")){
_52=CPAllPredicateModifier;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","NONE")){
_52=CPAnyPredicateModifier;
_57=YES;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","SOME")){
_52=CPAllPredicateModifier;
_57=YES;
}
}
...
_55=objj_msgSend(_50,"parseExpression");
if(objj_msgSend(_50,"scanString:intoString:","!=",NULL)||objj_msgSend(_50,"scanString:intoString:","<>",NULL)){
_53=CPNotEqualToPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanString:intoString:","<=",NULL)||objj_msgSend(_50,"scanString:intoString:","=<",NULL)){
_53=CPLessThanOrEqualToPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanString:intoString:",">=",NULL)||objj_msgSend(_50,"scanString:intoString:","=>",NULL)){
_53=CPGreaterThanOrEqualToPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanString:intoString:","<",NULL)){
_53=CPLessThanPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanString:intoString:",">",NULL)){
_53=CPGreaterThanPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanString:intoString:","==",NULL)||objj_msgSend(_50,"scanString:intoString:","=",NULL)){
_53=CPEqualToPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","MATCHES")){
_53=CPMatchesPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","LIKE")){
_53=CPLikePredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","BEGINSWITH")){
_53=CPBeginsWithPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","ENDSWITH")){
_53=CPEndsWithPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","IN")){
_53=CPInPredicateOperatorType;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","CONTAINS")){
_53=CPInPredicateOperatorType;
_58=YES;
}else{
if(objj_msgSend(_50,"scanPredicateKeyword:","BETWEEN")){
var exp=objj_msgSend(_50,"parseSimpleExpression"),a=objj_msgSend(exp,"constantValue"),_59,_5a,_5b,_5c,lp,up;
...
_59=objj_msgSend(a,"objectAtIndex:",0);
_5a=objj_msgSend(a,"objectAtIndex:",1);
_5b=objj_msgSend(CPExpression,"expressionForConstantValue:",_59);
_5c=objj_msgSend(CPExpression,"expressionForConstantValue:",_5a);
lp=objj_msgSend(CPComparisonPredicate,"predicateWithLeftExpression:rightExpression:modifier:type:options:",_55,_5b,_52,CPGreaterThanPredicateOperatorType,_54);
up=objj_msgSend(CPComparisonPredicate,"predicateWithLeftExpression:rightExpression:modifier:type:options:",_55,_5c,_52,CPLessThanPredicateOperatorType,_54);
return objj_msgSend(CPCompoundPredicate,"andPredicateWithSubpredicates:",objj_msgSend(CPArray,"arrayWithObjects:",lp,up));
}else{
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid comparison predicate: "+objj_msgSend(objj_msgSend(_50,"string"),"substringFromIndex:",objj_msgSend(_50,"scanLocation")));
}
}
}
}
...
if(objj_msgSend(_50,"scanString:intoString:","[cd]",NULL)){
_54=CPCaseInsensitivePredicateOption|CPDiacriticInsensitivePredicateOption;
}else{
if(objj_msgSend(_50,"scanString:intoString:","[c]",NULL)){
_54=CPCaseInsensitivePredicateOption;
}else{
if(objj_msgSend(_50,"scanString:intoString:","[d]",NULL)){
_54=CPDiacriticInsensitivePredicateOption;
}
}
}
_56=objj_msgSend(_50,"parseExpression");
if(_58==YES){
var tmp=_55;
_55=_56;
_56=tmp;
}
p=objj_msgSend(CPComparisonPredicate,"predicateWithLeftExpression:rightExpression:modifier:type:options:",_55,_56,_52,_53,_54);
return _57?objj_msgSend(CPCompoundPredicate,"notPredicateWithSubpredicate:",p):p;
}
}),new objj_method(sel_getUid("parseExpression"),function(_5d,_5e){
with(_5d){
return objj_msgSend(_5d,"parseBinaryExpression");
}
}),new objj_method(sel_getUid("parseSimpleExpression"),function(_5f,_60){
with(_5f){
var _61,_62,_63,dbl;
if(objj_msgSend(_5f,"scanDouble:",function(_64){
var _65=dbl;
...
if(objj_msgSend(_5f,"scanString:intoString:","-",NULL)){
return objj_msgSend(CPExpression,"expressionForFunction:arguments:","chs",objj_msgSend(CPArray,"arrayWithObject:",objj_msgSend(_5f,"parseExpression")));
}
if(objj_msgSend(_5f,"scanString:intoString:","(",NULL)){
var arg=objj_msgSend(_5f,"parseExpression");
if(!objj_msgSend(_5f,"scanString:intoString:",")",NULL)){
...
objj_msgSend(a,"addObject:",objj_msgSend(_5f,"parseExpression"));
while(objj_msgSend(_5f,"scanString:intoString:",",",NULL)){
objj_msgSend(a,"addObject:",objj_msgSend(_5f,"parseExpression"));
}
if(!objj_msgSend(_5f,"scanString:intoString:","}",NULL)){
...
if(objj_msgSend(_5f,"scanPredicateKeyword:","NULL")||objj_msgSend(_5f,"scanPredicateKeyword:","NIL")){
return objj_msgSend(CPExpression,"expressionForConstantValue:",objj_msgSend(CPNull,"null"));
}
if(objj_msgSend(_5f,"scanPredicateKeyword:","TRUE")||objj_msgSend(_5f,"scanPredicateKeyword:","YES")){
return objj_msgSend(CPExpression,"expressionForConstantValue:",objj_msgSend(CPNumber,"numberWithBool:",YES));
}
if(objj_msgSend(_5f,"scanPredicateKeyword:","FALSE")||objj_msgSend(_5f,"scanPredicateKeyword:","NO")){
return objj_msgSend(CPExpression,"expressionForConstantValue:",objj_msgSend(CPNumber,"numberWithBool:",NO));
}
if(objj_msgSend(_5f,"scanPredicateKeyword:","SELF")){
return objj_msgSend(CPExpression,"expressionForEvaluatedObject");
}
if(objj_msgSend(_5f,"scanString:intoString:","$",NULL)){
var _66=objj_msgSend(_5f,"parseExpression");
if(!objj_msgSend(_66,"keyPath")){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid variable identifier: "+_66);
}
return objj_msgSend(CPExpression,"expressionForVariable:",objj_msgSend(_66,"keyPath"));
}
_62=objj_msgSend(_5f,"scanLocation");
if(objj_msgSend(_5f,"scanString:intoString:","%",NULL)){
if(objj_msgSend(_5f,"isAtEnd")==NO){
var c=objj_msgSend(objj_msgSend(_5f,"string"),"characterAtIndex:",objj_msgSend(_5f,"scanLocation"));
switch(c){
case "%":
_62=objj_msgSend(_5f,"scanLocation");
break;
case "K":
objj_msgSend(_5f,"setScanLocation:",objj_msgSend(_5f,"scanLocation")+1);
return objj_msgSend(CPExpression,"expressionForKeyPath:",objj_msgSend(_5f,"nextArg"));
case "@":
case "c":
case "C":
case "d":
...
case "G":
objj_msgSend(_5f,"setScanLocation:",objj_msgSend(_5f,"scanLocation")+1);
return objj_msgSend(CPExpression,"expressionForConstantValue:",objj_msgSend(_5f,"nextArg"));
case "h":
objj_msgSend(_5f,"scanString:intoString:","h",NULL);
if(objj_msgSend(_5f,"isAtEnd")==NO){
c=objj_msgSend(objj_msgSend(_5f,"string"),"characterAtIndex:",objj_msgSend(_5f,"scanLocation"));
if(c=="i"||c=="u"){
objj_msgSend(_5f,"setScanLocation:",objj_msgSend(_5f,"scanLocation")+1);
return objj_msgSend(CPExpression,"expressionForConstantValue:",objj_msgSend(_5f,"nextArg"));
}
...
break;
case "q":
objj_msgSend(_5f,"scanString:intoString:","q",NULL);
if(objj_msgSend(_5f,"isAtEnd")==NO){
c=objj_msgSend(objj_msgSend(_5f,"string"),"characterAtIndex:",objj_msgSend(_5f,"scanLocation"));
if(c=="i"||c=="u"||c=="x"||c=="X"){
objj_msgSend(_5f,"setScanLocation:",objj_msgSend(_5f,"scanLocation")+1);
...
objj_msgSend(_5f,"setScanLocation:",_62);
}
if(objj_msgSend(_5f,"scanString:intoString:","\"",NULL)){
var _67=objj_msgSend(_5f,"charactersToBeSkipped"),str;
objj_msgSend(_5f,"setCharactersToBeSkipped:",nil);
if(objj_msgSend(_5f,"scanUpToString:intoString:","\"",function(_68){
var _69=str;
...
objj_msgSend(_5f,"setCharactersToBeSkipped:",_67);
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid double quoted literal at "+_62);
}
objj_msgSend(_5f,"scanString:intoString:","\"",NULL);
objj_msgSend(_5f,"setCharactersToBeSkipped:",_67);
...
var _67=objj_msgSend(_5f,"charactersToBeSkipped"),str;
objj_msgSend(_5f,"setCharactersToBeSkipped:",nil);
if(objj_msgSend(_5f,"scanUpToString:intoString:","'",function(_6a){
var _6b=str;
...
objj_msgSend(_5f,"setCharactersToBeSkipped:",_67);
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid single quoted literal at "+_62);
}
objj_msgSend(_5f,"scanString:intoString:","'",NULL);
objj_msgSend(_5f,"setCharactersToBeSkipped:",_67);
return objj_msgSend(CPExpression,"expressionForConstantValue:",str);
...
if(objj_msgSend(_5f,"scanString:intoString:","@",NULL)){
var e=objj_msgSend(_5f,"parseExpression");
...
objj_msgSend(_5f,"scanString:intoString:","#",NULL);
if(!_61){
_61=objj_msgSend(CPCharacterSet,"characterSetWithCharactersInString:","_$abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
}
if(!objj_msgSend(_5f,"scanCharactersFromSet:intoString:",_61,function(_6c){
var _6d=_63;
...
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Missing identifier: "+objj_msgSend(objj_msgSend(_5f,"string"),"substringFromIndex:",objj_msgSend(_5f,"scanLocation")));
}
return objj_msgSend(CPExpression,"expressionForKeyPath:",_63);
}
...
var _71=objj_msgSend(CPMutableArray,"arrayWithCapacity:",5);
if(!objj_msgSend(_70,"keyPath")){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid function identifier: "+_70);
}
if(!objj_msgSend(_6e,"scanString:intoString:",")",NULL)){
objj_msgSend(_71,"addObject:",objj_msgSend(_6e,"parseExpression"));
...
_70=objj_msgSend(CPExpression,"expressionForFunction:arguments:",objj_msgSend(_70,"keyPath"),_71);
}else{
if(objj_msgSend(_6e,"scanString:intoString:","[",NULL)){
if(objj_msgSend(_6e,"scanPredicateKeyword:","FIRST")){
_70=objj_msgSend(CPExpression,"expressionForFunction:arguments:","first",objj_msgSend(CPArray,"arrayWithObject:",objj_msgSend(_6e,"parseExpression")));
}else{
if(objj_msgSend(_6e,"scanPredicateKeyword:","LAST")){
_70=objj_msgSend(CPExpression,"expressionForFunction:arguments:","last",objj_msgSend(CPArray,"arrayWithObject:",objj_msgSend(_6e,"parseExpression")));
}else{
if(objj_msgSend(_6e,"scanPredicateKeyword:","SIZE")){
_70=objj_msgSend(CPExpression,"expressionForFunction:arguments:","count",objj_msgSend(CPArray,"arrayWithObject:",objj_msgSend(_6e,"parseExpression")));
}else{
_70=objj_msgSend(CPExpression,"expressionForFunction:arguments:","index",objj_msgSend(CPArray,"arrayWithObjects:",_70,objj_msgSend(_6e,"parseExpression")));
}
}
}
if(!objj_msgSend(_6e,"scanString:intoString:","]",NULL)){
...
if(objj_msgSend(_6e,"scanString:intoString:",".",NULL)){
if(!objj_msgSend(_70,"keyPath")){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid left keypath:"+_70);
}
var _72=objj_msgSend(_6e,"parseExpression");
if(!objj_msgSend(_72,"keyPath")){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Invalid right keypath:"+_72);
}
_70=objj_msgSend(CPExpression,"expressionForKeyPath:",objj_msgSend(_70,"keyPath")+"."+objj_msgSend(_72,"keyPath"));
}else{
return _70;
}
}
...
}),new objj_method(sel_getUid("parsePowerExpression"),function(_73,_74){
with(_73){
var _75=objj_msgSend(_73,"parseFunctionalExpression");
while(YES){
var _76;
if(objj_msgSend(_73,"scanString:intoString:","**",NULL)){
_76=objj_msgSend(_73,"parseFunctionalExpression");
_75=objj_msgSend(CPExpression,"expressionForFunction:arguments:","pow",objj_msgSend(CPArray,"arrayWithObjects:",_75,_76));
}else{
return _75;
}
}
}
}),new objj_method(sel_getUid("parseMultiplicationExpression"),function(_77,_78){
with(_77){
var _79=objj_msgSend(_77,"parsePowerExpression");
while(YES){
var _7a;
if(objj_msgSend(_77,"scanString:intoString:","*",NULL)){
_7a=objj_msgSend(_77,"parsePowerExpression");
_79=objj_msgSend(CPExpression,"expressionForFunction:arguments:","_mul",objj_msgSend(CPArray,"arrayWithObjects:",_79,_7a));
}else{
if(objj_msgSend(_77,"scanString:intoString:","/",NULL)){
_7a=objj_msgSend(_77,"parsePowerExpression");
_79=objj_msgSend(CPExpression,"expressionForFunction:arguments:","_div",objj_msgSend(CPArray,"arrayWithObjects:",_79,_7a));
}else{
return _79;
}
}
...
}),new objj_method(sel_getUid("parseAdditionExpression"),function(_7b,_7c){
with(_7b){
var _7d=objj_msgSend(_7b,"parseMultiplicationExpression");
while(YES){
var _7e;
if(objj_msgSend(_7b,"scanString:intoString:","+",NULL)){
_7e=objj_msgSend(_7b,"parseMultiplicationExpression");
_7d=objj_msgSend(CPExpression,"expressionForFunction:arguments:","_add",objj_msgSend(CPArray,"arrayWithObjects:",_7d,_7e));
}else{
if(objj_msgSend(_7b,"scanString:intoString:","-",NULL)){
_7e=objj_msgSend(_7b,"parseMultiplicationExpression");
_7d=objj_msgSend(CPExpression,"expressionForFunction:arguments:","_sub",objj_msgSend(CPArray,"arrayWithObjects:",_7d,_7e));
}else{
return _7d;
}
}
...
}),new objj_method(sel_getUid("parseBinaryExpression"),function(_7f,_80){
with(_7f){
var _81=objj_msgSend(_7f,"parseAdditionExpression");
while(YES){
var _82;
if(objj_msgSend(_7f,"scanString:intoString:",":=",NULL)){
_82=objj_msgSend(_7f,"parseAdditionExpression");
}else{
return _81;
}
}
